...
public class TTTPVO {
	...
	public TTTPVO(String professorId, String name, String phoneId, String gender, String email, String pw, String day,
			int period, int teachingNo, String subjectName, int headCount, int point, float totalScore, int teachYear,
	...
	public String toString() {
		return "TTTPVO [professorId=" + professorId + ", name=" + name + ", phoneId=" + phoneId + ", gender=" + gender
				+ ", email=" + email + ", pw=" + pw + ", day=" + day + ", period=" + period + ", teachingNo="
				+ teachingNo + ", subjectName=" + subjectName + ", headCount=" + headCount + ", point=" + point
				+ ", totalScore=" + totalScore + ", teachYear=" + teachYear + ", teachSemester=" + teachSemester
				+ ", aRatio=" + aRatio + ", bRatio=" + bRatio + ", cRatio=" + cRatio + ", dRatio=" + dRatio
