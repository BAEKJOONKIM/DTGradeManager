...
public class RTPVO {
	...
	//constructor
	public RTPVO() {}
	public RTPVO(int registerNo, float middle, float finals, float report, float attend, String grade, String studentId,
	...
	public String toString() {
		return "RTPVO [registerNo=" + registerNo + ", middle=" + middle + ", finals=" + finals + ", report=" + report
